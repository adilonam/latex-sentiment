...
\pagedegarde{ENSA4/GI/23-24}{d'annee}{Abdelhak Mekaoui}{Adil Abbadi}{Genie Informatique}{Conception, Developpement et Deploiement d'un Chatbot Inte lligent et d'une Plate forme E-Learning}{M. A EL YOUSFI}{M. H Elkina}{assets/images/code.png}{0.5}{M. H AKSASSE}{M. M ELYAAKOUBI}{03/06/2024}
\Newpage
...
\centering
\rotatebox{90}{\includegraphics[width=1.5\textwidth]{assets/images/architecture.png}} % Remplacez par le chemin de votre diagramme d'architecture
